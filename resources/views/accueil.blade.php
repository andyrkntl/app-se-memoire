...
@section('content')
<div id="fb-root"></div>
<script async defer crossorigin="anonymous" src="https://connect.facebook.net/fr_FR/sdk.js#xfbml=1&version=v21.0&appId=1326305115204042"></script>
...
<div class="row">
    ...
    @php
        $stats = [
            ['icon' => 'ti-pie-chart', 'value' => $totalChantier ?? '4', 'label' => 'Total Chantiers', 'bg' => 'bg-info'],
            ['icon' => 'ti-time', 'value' => $activitesEnCours ?? '3', 'label' => 'Activités en Cours', 'bg' => 'bg-warning'],
            ['icon' => 'ti-check-box', 'value' => $activitesRealisees ?? '1', 'label' => 'Activités Réalisées', 'bg' => 'bg-success'],
            ['icon' => 'ti-close', 'value' => $activitesNonRealisees ?? '1', 'label' => 'Activités Non Réalisées', 'bg' => 'bg-danger']
        ];
    @endphp
        ...
        <div class="card">
            <div class="card-body">
                <div class="d-flex no-block align-items-center">
                    <div class="m-r-10"><i class="{{ $stat['icon'] }} text-white {{ $stat['bg'] }} p-3 rounded-circle"></i></div>
                    <div>
    ...
    <div class="col-lg-12">
        <div class="card">
            ...
            <div class="card-body ">
                ...
                @else
                    <div class="fb-page" data-href="https://www.facebook.com/communication.prea"
                     data-tabs="timeline"
                      data-width="1100"
                      data-height="800"
...
<script>
    ...
    const chantierStatusData = {
        ...
        datasets: [{
            data: [{{ $activitesEnCours ?? 3 }}, {{ $activitesRealisees ?? 1 }}, {{ $activitesNonRealisees ?? 1 }}],
