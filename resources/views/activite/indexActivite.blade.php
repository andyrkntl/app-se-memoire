...
@section('content')
    ...
    <div class="row page-titles">
        <div class="col-md-5 col-8 align-self-center">
            <h3 class="text-themecolor m-b-0 m-t-0">Activité</h3>
            <ol class="breadcrumb">
        ...
        <div class="card-body">
            <div class="d-flex no-block">
                <button type="button" class="btn waves-effect waves-light btn-rounded btn-primary" data-toggle="modal"
                    ...
                    <i class=""></i> Insérer une nouvelle activité
                </button>
                    ...
                    <thead>
                        <tr role="row">
                            ...
                            <th class="sorting" tabindex="0" aria-controls="example23" rowspan="1" colspan="1"
                                style="width: 135px;" aria-label="Office: activate to sort column ascending">Date de debut
                            </th>
                            <th class="sorting" tabindex="0" aria-controls="example23" rowspan="1" colspan="1"
                                style="width: 66px;" aria-label="Age: activate to sort column ascending">Date fin</th>
                            <th class="sorting" tabindex="0" aria-controls="example23" rowspan="1" colspan="1"
                                style="width: 117px;" aria-label="Start date: activate to sort column ascending">Statut</th>
                            <th class="sorting" tabindex="0" aria-controls="example23" rowspan="1" colspan="1"
                        ...
                        @foreach ($activite as $a)
                            <tr class=" align-items-center">
                                ...
                                <td>
                                    ...
                                    @endphp
                                    <span
                                        style="color: white; background-color: {{ $color }}; padding: 5px; border-radius: 5px;">
                                        {{ $a->Statut_activite }}
                                    </span>
                                </td>
                                <td class="text-center">
                                    <div class="d-flex justify-content-center">
                                        <form class="" action="{{ route('activite.show', $a->id) }}" method="GET">
                                            @csrf
                                            @method('GET')
                                        ...
                                        <form action="{{ route('activite.destroy', $a->id) }}" method="POST"
